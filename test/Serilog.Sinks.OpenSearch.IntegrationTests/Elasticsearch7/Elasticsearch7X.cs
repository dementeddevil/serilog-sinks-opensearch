...
{
    public class OpenSearch7X : OpenSearch7XTestBase, IClassFixture<OpenSearch7X.SetupSerilog>
    {
        private readonly SetupSerilog _setup;

        public OpenSearch7X(OpenSearch7XCluster cluster, SetupSerilog setup) : base(cluster) => _setup = setup;
