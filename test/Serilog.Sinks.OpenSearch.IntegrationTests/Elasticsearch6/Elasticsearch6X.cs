...
{
    public class OpenSearch6X : OpenSearch6XTestBase, IClassFixture<OpenSearch6X.SetupSerilog>
    {
        private readonly SetupSerilog _setup;

        public OpenSearch6X(OpenSearch6XCluster cluster, SetupSerilog setup) : base(cluster) => _setup = setup;
        ...
        [I] public void AssertLogs()
        {
            ...
            var search = Client.Search<object>(s => s
                ...
                .Type(OpenSearchSinkOptions.DefaultTypeName)
            );
